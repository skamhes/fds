...
INTEGER, PARAMETER :: HOLE_SPHERE_TYPE=1               !< Flag for ????\%SHAPE_TYPE
INTEGER, PARAMETER :: HOLE_CYLINDER_TYPE=2             !< Flag for ????\%SHAPE_TYPE
INTEGER, PARAMETER :: HOLE_CONE_TYPE=3                 !< Flag for ????\%SHAPE_TYPE
INTEGER, PARAMETER :: HOLE_BOX_TYPE=4                  !< Flag for ????\%SHAPE_TYPE
